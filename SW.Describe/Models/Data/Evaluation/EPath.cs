...
{
    public class EPath : IEquatable<EPath>, IEnumerable<EPath.INode>
    {
        ...
        EPath(EPath parent, INode token)
        {
            _parent = parent;
            _token = token;
        ...
        public static bool TryParse(string representation, out EPath path)
        {
        ...
        public static EPath Parse(string representation)
        {
            if (!TryParse(representation, out EPath path))
            {
        ...
        public EPath Append(int index) => Append(new Index(index));

        //public ContentPath Append(ContentPath another) => Append(another.Nodes);

        public EPath Append(IEnumerable<INode> nodes)
        {
            var p = this;
        ...
        public EPath Append(string property)
        {
        ...
        public EPath Append(INode node)
        {
            if (node == null) throw new ArgumentNullException(nameof(node));
            
            return new EPath(this, node);
        }
        ...
        public EPath Sub(int skip, int? take = null) => 
